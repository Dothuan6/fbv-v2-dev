...
(function () {
  ...
  FBV.icon = (n, cls) => `<svg ${cls ? `class="${cls}"` : ''} viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${P[n] || ''}</svg>`;
  ...
  FBV.brandMark = () => `<svg class="brand-mark" viewBox="0 0 40 40" aria-hidden="true"><defs><linearGradient id="bmg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#1FB6D6"/><stop offset=".35" stop-color="#16A085"/><stop offset=".7" stop-color="#F5A623"/><stop offset="1" stop-color="#7B2FF7"/></linearGradient></defs><circle cx="20" cy="20" r="18" fill="none" stroke="url(#bmg)" stroke-width="3.2"/><path d="M9 26c4-9 8-12 11-12s7 3 11 12" fill="none" stroke="url(#bmg)" stroke-width="2.4" stroke-linecap="round"/><path d="M9 14c4 9 8 12 11 12s7-3 11-12" fill="none" stroke="url(#bmg)" stroke-width="2.4" stroke-linecap="round" opacity=".55"/><circle cx="20" cy="20" r="5.2" fill="#F5A623"/></svg>`;
